...
int16_t Kickball2_SpringRawAngle = 312;         // 弹簧原长对应的角度,改为往下拉，防止正投影与球接触
int16_t Kickball2_SpringAutoRecoverAngle = 320; // 弹簧能自动拉回的角度
float Kickball2_KickCurrent = -7;               // CMD设置或使用默认值-5
